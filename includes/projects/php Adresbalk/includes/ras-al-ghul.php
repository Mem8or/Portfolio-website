<?php
	$title = 'Batman Villains - Ra\'s al Ghul';
	$image1 = '<img src="./images/Ra\'s_al_Ghul-1.jpg" alt="Ra\'s al Ghul">';
	$image2 = '<img src="./images/siddig.jpg" alt="Ra\'s al Ghul">';
	$sectiontext = '<h1>Ra\'s al Ghul</h1>
					<p>Ra\'s al Ghul, sometimes written Rā\'s al Ghūl, is a DC Comics supervillain and an enemy of Batman. His name is Arabic for "head of the demon". Created by writer Dennis O\'Neil and artist Neal Adams, he was introduced in Batman #232\'s "Daughter of the Demon" (June 1971). He has also come into conflict with Superman and other DC Comics superheroes.</p>
